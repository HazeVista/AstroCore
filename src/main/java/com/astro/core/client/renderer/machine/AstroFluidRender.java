...
public class AstroFluidRender extends DynamicRender<IFluidRenderMulti, AstroFluidRender> {

    public static final AstroFluidRender INSTANCE = new AstroFluidRender();
    public static final Codec<AstroFluidRender> CODEC = Codec.unit(AstroFluidRender::new);
    public static final DynamicRenderType<IFluidRenderMulti, AstroFluidRender> TYPE = new DynamicRenderType<>(CODEC);
    ...
    @Override
    public @NotNull DynamicRenderType<IFluidRenderMulti, AstroFluidRender> getType() {
        return TYPE;
    }
