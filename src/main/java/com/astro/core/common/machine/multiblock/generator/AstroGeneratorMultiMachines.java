...
public class AstroGeneratorMultiMachines {
    ...
    public static void init() {
        ...
        FARADAY_GENERATOR = REGISTRATE
                .multiblock("faraday_electromagnetic_generator", /*FaradayGeneratorMachine*/WorkableElectricMultiblockMachine::new)
                .rotationState(ALL)
...
//                .recipeModifiers(FaradayGeneratorMachine::recipeModifier, BATCH_MODE)
                ...
                .pattern(definition -> FactoryBlockPattern.start()
                        ...
                        .aisle(" XXXXX ", "X MMM X", "XM   MX", "XM C MX", "XM   MX", "X MMM X", " XXXXX ")
                        .aisle(" XXXXX ", "X MMM X", "XM   MX", "XM C MX", "XM   MX", "X MMM X", " XXXXX ")
                        .aisle(" XXXXX ", "X MMM X", "XM   MX", "XM C MX", "XM   MX", "X MMM X", " XXXXX ").setRepeatable(1, 61)
                        .aisle(" XXXXX ", "XXXXXXX", "XXGXGXX", "XXG@GXX", "XXGXGXX", "XXXXXXX", " XXXXX ")
                        .where('@', controller(blocks(definition.get())))
                        .where('X', Predicates.blocks(GCYMBlocks.CASING_NONCONDUCTING.get())
                ...
                .shapeInfos(definition -> {
                    ...
                    var builder = MultiblockShapeInfo.builder()
                            ...
                            .where('M', ELECTROMAGNET_MK1.get().defaultBlockState())
                            .where('C', FARADAY_GENERATOR_COIL.get().defaultBlockState())
                    ...
                    for (int length = 1; length <= 61; length++) {
                        ...
                        aisles.add(new String[] {" IOFXX ", "XXXXXXX", "XXGXGXX", "XXG@GXX", "XXGXGXX", "XXXXXXX", " XXXXX "});
                        aisles.add(new String[] {" XXXXX ", "X MMM X", "XM   MX", "XM C MX", "XM   MX", "X MMM X", " XXXXX "});
                        aisles.add(new String[] {" XXXXX ", "X MMM X", "XM   MX", "XM C MX", "XM   MX", "X MMM X", " XXXXX "});
                        aisles.add(new String[] {" XXXXX ", "X MMM X", "XM   MX", "XM C MX", "XM   MX", "X MMM X", " XXXXX "});
                        aisles.add(new String[] {" XXXXX ", "X MMM X", "XM   MX", "XM C MX", "XM   MX", "X MMM X", " XXXXX "});
                        ...
                        aisles.add(new String[] {" XXXXX ", "XXXXXXX", "XXGXGXX", "XXGDGXX", "XXGXGXX", "XXXXXXX", " XXXXX "});
